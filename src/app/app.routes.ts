...
export const routes: Routes = [
  ...
  { path: 'directory', loadComponent: () => import('./features/directory/directory').then((m) => m.Directory), title: title('Danh bạ') },
  ...
  { path: 'feed', loadComponent: () => import('./features/feed/feed').then((m) => m.Feed), title: title('Bảng tin') },
